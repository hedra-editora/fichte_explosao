...
\linha{sobre o apoio}{\patrociniomensagem}

\IfFileExists{patrocinio.png}{\includegraphics[width=25mm]{patrocinio.png}}

\IfFileExists{apoio.png}{\textsc{apoio}:
      \includegraphics[width=25mm]{apoio.png}
      }
...
\ifdef{\organizacao}{{\small {\organizacao} (\textit{cocuradores do Projeto Fichte})} \par}{}
